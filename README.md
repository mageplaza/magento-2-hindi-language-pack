...
Unzip the compressed file and upload file `master.zip` into `app/i18n/Mageplaza/hi_in/hi_IN.csv`

See this screenshot

![Hindi pack](https://cdn2.mageplaza.com/media/general2/tS668yC.png)
