...
2. [Install Hindi Language Pack](#2-how-to-install-hungarian-language-pack)
3. [How to active Hindi language pack](#3-how-to-active-hungarian-language-pack)
...
## 3. How to active Hindi language pack {#active}
